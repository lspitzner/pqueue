...
takeWhile :: Ord a => (a -> Bool) -> BMinQueue a -> [a]
...
dropWhile :: Ord a => (a -> Bool) -> BMinQueue a -> BMinQueue a
...
span :: Ord a => (a -> Bool) -> BMinQueue a -> ([a], BMinQueue a)
...
break :: Ord a => (a -> Bool) -> BMinQueue a -> ([a], BMinQueue a)
break p = span (not . p)
...
drop :: Ord a => Int -> BMinQueue a -> BMinQueue a
...
splitAt :: Ord a => Int -> BMinQueue a -> ([a], BMinQueue a)
...
filter :: Ord a => (a -> Bool) -> BMinQueue a -> BMinQueue a
...
partition :: Ord a => (a -> Bool) -> BMinQueue a -> (BMinQueue a, BMinQueue a)
...
map :: Ord b => (a -> b) -> BMinQueue a -> BMinQueue b
